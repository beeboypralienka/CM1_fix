...
disp('CM1_IG Calculation in progress...');
...
%---
    ...
    %---            
        ...
        for iBarisData = 1 : size(CM1_01_IG,1)  %Iterasi baris data 
            %---- TRAINING
            if CM1_00_TrainIdx(iBarisData,iFold) == 1 %Kalau TrainIdx 1                 
                CM1_02_Train{1,iFitur}{iFold,1}(iTraining,1:iFitur) = CM1_01_IG(iBarisData,1:iFitur); %Sengaja dipisah kelasnya, karena ada iterasi fitur
                CM1_02_Train{1,iFitur}{iFold,1}(iTraining,iFitur+1) = CM1_01_IG(iBarisData,end); %Tambah kelas dari kolom paling terakhir di "CM1_01_IG"
            ...
            %---- TESTING
                ...
                CM1_03_Test{1,iFitur}{iFold,1}(iTesting,1:iFitur) = CM1_01_IG(iBarisData,1:iFitur); %Sengaja dipisah kelasnya, karena ada iterasi fitur           
                CM1_03_Test{1,iFitur}{iFold,1}(iTesting,iFitur+1) = CM1_01_IG(iBarisData,end); %Tambah kelas dari kolom paling terakhir di "CM1_01_IG"
...
CM1_57_MAX_Mean_BAL = [urutan nilai size(CM1_01_IG,2)-1 toc seed]; %Simpan ke 'CM1_57_MAX_Mean_BAL'
clear nilai urutan;
