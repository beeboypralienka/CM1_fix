...
%============================================================================================
%                     .::  CM1_04_Train_False && CM1_05_Train_True ::.
%============================================================================================
        fgFalse = 0;
        fgTrue = 0;        
...
%============================================================================================
%                     .::  CM1_08_HamDist_C1 && CM1_09_HamDist_C2  ::.
%============================================================================================
...
%============================================================================================
        ...
        for iBarisAvg = 1 : length(CM1_02_Train{1,iFitur}{iFold,1})
            ...
            if averageC1 < averageC2                
                CM1_10_Avg_HamDist{1,iFitur}{iFold,1}(iBarisAvg,3) = 11111;
            else CM1_10_Avg_HamDist{1,iFitur}{iFold,1}(iBarisAvg,3) = 22222;
            end                                                              
        end
        clear iBarisAvg averageC1 averageC2;
           
%============================================================================================
%                      .::  CM1_11_Anggota_C1 && CM1_12_Anggota_C2  ::.
%============================================================================================                        
        fgC1 = 0;
        fgC2 = 0;
        ...
        %-------------------------------------------------------------------------------------------------------------
        % Prevent Fold "CM1_11_Anggota_C1" yang hilang karena tidak dianggap ada oleh matLab, dibuat matrix kosong []  
        %-------------------------------------------------------------------------------------------------------------
        if size(CM1_12_Anggota_C2{1,iFitur}{iFold,1},1) == length(CM1_02_Train{1,iFitur}{iFold,1})
            CM1_11_Anggota_C1{1,iFitur}{iFold,1} = [];
        end    
        %-------------------------------------------------------------------------------------------------------------
...
%                                   .::  CM1_13_Mean_C1  ::.
%============================================================================================                
        if size(CM1_11_Anggota_C1{1,iFitur}{iFold,1},1) ~= 0                            
            %---------------------------------------------------------
            % Kondisi kalau baris datanya cuma 1, ga usah hitung mean
            %---------------------------------------------------------
            if size(CM1_11_Anggota_C1{1,iFitur}{iFold,1},1) == 1                
                CM1_13_Mean_C1{1,iFitur}{iFold,1}(1,:) = CM1_11_Anggota_C1{1,iFitur}{iFold,1};
            else
                CM1_13_Mean_C1{1,iFitur}{iFold,1}(1,:) = mean(CM1_11_Anggota_C1{1,iFitur}{iFold,1}(:,1:iFitur));
            end                 
        end        
        %----------------------------------------------------------------------------------------------------------
        % Prevent Fold "CM1_13_Mean_C1" yang hilang karena tidak dianggap ada oleh matLab, dibuat matrix kosong []  
        %----------------------------------------------------------------------------------------------------------
        if size(CM1_12_Anggota_C2{1,iFitur}{iFold,1},1) == length(CM1_02_Train{1,iFitur}{iFold,1})
            CM1_13_Mean_C1{1,iFitur}{iFold,1} = [];
        end        
...
%============================================================================================                         
        if size(CM1_12_Anggota_C2{1,iFitur}{iFold,1},1) ~= 0            
            ...
            if size(CM1_12_Anggota_C2{1,iFitur}{iFold,1},1) == 1                
                ...
                CM1_14_Mean_C2{1,iFitur}{iFold,1}(1,:) = mean(CM1_12_Anggota_C2{1,iFitur}{iFold,1}(:,1:iFitur));
            end                  
        end                    
        %----------------------------------------------------------------------------------------------------------
...
%============================================================================================
%                     .::  CM1_15_Titik_C1_New  &&  CM1_16_Titik_C2_New  ::.
%============================================================================================                              
        for iSeleksiFitur = 1 : iFitur                        
            %---------
            % MEAN C1
            %---------            
            if size(CM1_13_Mean_C1{1,iFitur}{iFold,1},1) ~= 0                
            ...
            %---------------------------------------------------------------------------------------------------------------
            % Prevent Fold "CM1_15_Titik_C1_New" yang hilang karena tidak dianggap ada oleh matLab, dibuat matrix kosong []      
            %---------------------------------------------------------------------------------------------------------------
            if length(CM1_12_Anggota_C2{1,iFitur}{iFold,1}) == length(CM1_02_Train{1,iFitur}{iFold,1})
                CM1_15_Titik_C1_New{1,iFitur}{iFold,1} = [];
            end
            %---------------------------------------------------------------------------------------------------------------
            % Prevent Fold "CM1_16_Titik_C2_New" yang hilang karena tidak dianggap ada oleh matLab, dibuat matrix kosong []      
            %---------------------------------------------------------------------------------------------------------------
...
%============================================================================================
%                     .::  CM1_17_HamDist_C1_new  &&  CM1_18_HamDist_C2_new  ::.
%============================================================================================
        for iKolomCluster = 1 : iFitur
            for iBarisCluster = 1 : length(CM1_02_Train{1,iFitur}{iFold,1})              
                %------------
                ...
                data = CM1_02_Train{1,iFitur}{iFold,1}(iBarisCluster,iKolomCluster);
                %----------------------
                % Jarak data ke C1_new
                %----------------------
                if length(CM1_15_Titik_C1_New{1,iFitur}{iFold,1}) ~= 0                    
                    ...
                    CM1_17_HamDist_C1_new{1,iFitur}{iFold,1} = [];
                end                
                %----------------------
                % Jarak data ke C2_new
                %----------------------
