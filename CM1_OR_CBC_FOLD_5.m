...
disp('CM1 OR Calculation in progress...');
...
%---
    ...
    %---
        ...
        iTraining = 1; 
        iTesting = 1;                     
        for iBarisData = 1 : length(CM1_01_OR)            
            if CM1_00_TrainIdx(iBarisData,iFold) == 1 %---- TRAINING                 
                CM1_02_Train{1,iFitur}{iFold,1}(iTraining,1:iFitur) = CM1_01_OR(iTraining,1:iFitur); 
                CM1_02_Train{1,iFitur}{iFold,1}(iTraining,iFitur+1) = CM1_01_OR(iTraining,22); % Tambah kelas
                CM1_02_Train{1,iFitur}{iFold,1}(iTraining,iFitur+2) = iBarisData; % Tambah urutan data
                iTraining = iTraining + 1;            
            else %---- TESTING                                        
                CM1_03_Test{1,iFitur}{iFold,1}(iTesting,1:iFitur) = CM1_01_OR(iTesting,1:iFitur);            
                CM1_03_Test{1,iFitur}{iFold,1}(iTesting,iFitur+1) = CM1_01_OR(iTesting,22); % Tambah kelas
