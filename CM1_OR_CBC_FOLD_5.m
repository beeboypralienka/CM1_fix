...
% Load file OR 
%--------------
CM1_01_OR = csvread('03_SeleksiFitur\CM1_OR\CM1_OR.csv');
...
%-------------
k = 5;
vektorCM1 = CM1_01_OR(:,1);
cvFolds = crossvalind('Kfold', vektorCM1, k);
clear vektorCM1; 
    
disp('CM1_OR Calculation in progress...');
...
%---
    ...
    %---            
        ...
        for iBarisData = 1 : size(CM1_01_OR,1)  %Iterasi baris data 
            %---- TRAINING
            if CM1_00_TrainIdx(iBarisData,iFold) == 1 %Kalau TrainIdx 1                 
                CM1_02_Train{1,iFitur}{iFold,1}(iTraining,1:iFitur) = CM1_01_OR(iBarisData,1:iFitur); %Sengaja dipisah kelasnya, karena ada iterasi fitur
                CM1_02_Train{1,iFitur}{iFold,1}(iTraining,iFitur+1) = CM1_01_OR(iBarisData,end); %Tambah kelas dari kolom paling terakhir di "CM1_01_OR"
            ...
            %---- TESTING
                ...
                CM1_03_Test{1,iFitur}{iFold,1}(iTesting,1:iFitur) = CM1_01_OR(iBarisData,1:iFitur); %Sengaja dipisah kelasnya, karena ada iterasi fitur           
                CM1_03_Test{1,iFitur}{iFold,1}(iTesting,iFitur+1) = CM1_01_OR(iBarisData,end); %Tambah kelas dari kolom paling terakhir di "CM1_01_OR"
...
CM1_57_MAX_Mean_BAL = [urutan nilai size(CM1_01_OR,2)-1 toc seed]; %Simpan ke 'CM1_57_MAX_Mean_BAL'
clear nilai urutan;
...
disp('Saving...');
    tic
        save('04_CBC\CM1_OR_CBC_FOLD_5.mat');        
    toc
disp('Done!');
