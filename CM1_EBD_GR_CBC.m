...
% 
% % ------------------------------------------------------------------------
% % Testing ngambilnya dari atas dan bawah dataset, sisannya adalah training
% % ------------------------------------------------------------------------
% iTesting = 0;
% iTrain = 0;
...
%         iTrain = iTrain + 1;
%         dataTraining(iTrain,:) = CM1_01_GR(iPembagian,:);  
%     else
%         iTesting = iTesting + 1;
%         dataTesting(iTesting,:) = CM1_01_GR(iPembagian,:);  
%     end
% end
