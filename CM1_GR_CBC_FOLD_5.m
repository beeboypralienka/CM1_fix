...
disp('CM1_GR Calculation in progress...');
...
%---
    ...
    %---            
        ...
        for iBarisData = 1 : size(CM1_01_GR,1)  %Iterasi baris data 
            %---- TRAINING
            if CM1_00_TrainIdx(iBarisData,iFold) == 1 %Kalau TrainIdx 1                 
                CM1_02_Train{1,iFitur}{iFold,1}(iTraining,1:iFitur) = CM1_01_GR(iBarisData,1:iFitur); %Sengaja dipisah kelasnya, karena ada iterasi fitur
                CM1_02_Train{1,iFitur}{iFold,1}(iTraining,iFitur+1) = CM1_01_GR(iBarisData,end); %Tambah kelas dari kolom paling terakhir di "CM1_01_GR"
            ...
            %---- TESTING
                ...
                CM1_03_Test{1,iFitur}{iFold,1}(iTesting,1:iFitur) = CM1_01_GR(iBarisData,1:iFitur); %Sengaja dipisah kelasnya, karena ada iterasi fitur           
                CM1_03_Test{1,iFitur}{iFold,1}(iTesting,iFitur+1) = CM1_01_GR(iBarisData,end); %Tambah kelas dari kolom paling terakhir di "CM1_01_GR"
...
CM1_57_MAX_Mean_BAL = [urutan nilai size(CM1_01_GR,2)-1 toc seed]; %Simpan ke 'CM1_57_MAX_Mean_BAL'
clear nilai urutan;
...
disp('Saving...');
    tic
        save('04_CBC\CM1_GR_CBC_FOLD_5.mat');        
    toc
disp('Done!');
